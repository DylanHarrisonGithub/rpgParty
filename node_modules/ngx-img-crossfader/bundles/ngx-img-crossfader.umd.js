(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-img-crossfader', ['exports', '@angular/core'], factory) :
    (factory((global['ngx-img-crossfader'] = {}),global.ng.core));
    ...
    var NgxImgCrossfaderComponent = /** @class */ (function () {
        ...
        NgxImgCrossfaderComponent.propDecorators = {
            initDelayMS: [{ type: core.Input }],
            idleTimeMS: [{ type: core.Input }],
            transitionTimeMS: [{ type: core.Input }],
            autoAdvance: [{ type: core.Input }],
            imageSources: [{ type: core.Input }],
            backgroundColor: [{ type: core.Input }],
            bkgCrossfaderDiv: [{ type: core.ViewChild, args: ['bkgCrossfaderDiv',] }],
            bkgCrossfaderImg1: [{ type: core.ViewChild, args: ['bkgCrossfaderImg1',] }],
            bkgCrossfaderImg2: [{ type: core.ViewChild, args: ['bkgCrossfaderImg2',] }]
        };
     ...
     * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
     */
    var NgxImgCrossfaderModule = /** @class */ (function () {
        function NgxImgCrossfaderModule() {
        }
    ...
    exports.NgxImgCrossfaderComponent = NgxImgCrossfaderComponent;
    exports.NgxImgCrossfaderModule = NgxImgCrossfaderModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=ngx-img-crossfader.umd.js.map